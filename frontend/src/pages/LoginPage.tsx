    ...
    <div className="min-h-screen bg-background flex text-foreground">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative overflow-hidden">
        <div className="absolute top-10 left-10">
           <Link to="/" className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors group">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <div className="mb-10">
            <h1 className="text-3xl font-black text-foreground tracking-tight mb-2 uppercase italic">Connexion</h1>
            <p className="text-sm text-muted-foreground font-bold uppercase tracking-widest flex items-center gap-2">
              <span className="w-1 h-1 rounded-full bg-accent" /> Espace de certification central
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Email ou nom d'utilisateur</label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="VOTRE_ID@RESEAU"
                  />
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Code d'accès sécurisé</label>
                <div className="relative group">
            ...
            >
              {isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : <>Initialiser la Session <ArrowRight className="w-4 h-4" /></>}
            </button>
          </form>
      ...
      <div className="absolute bottom-6 right-6 opacity-20 hidden lg:block">
         <p className="text-[9px] font-bold uppercase tracking-[0.4em]">Auth_Core v4.0.1</p>
      </div>
    </div>
  );
}
